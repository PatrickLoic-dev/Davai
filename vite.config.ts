  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          id: '/',
          name: 'Davai — Apprends le russe',
          short_name: 'Davai',
          description: "Apprends le russe de zéro : alphabet cyrillique, vocabulaire, grammaire et exercices interactifs.",
          lang: 'fr',
          start_url: '/',
          scope: '/',
          display: 'standalone',
        ...
        workbox: {
          // Never serve a cached index.html for API/auth calls to Supabase —
          // only the app shell and static assets should be cached offline.
    ...
    server: {
      ...
      strictPort: true,
      watch: { ignored: ['**/.figma/**'] },
      hmr: process.env.FIGMA_PUBLIC_URL ? false : true,
    },
    preview: {
      host: '0.0.0.0',
      port: parseInt(process.env.PORT || '8443'),
